...
/*let resposta = 42;  declarar variável  */


//Jogar a moeda e sortear uma de duas opções

function flipCoin(){
   Math.floor( Math.random() * 2); //função floor serve para arredondar
}

//Converter resultado em string(no caso cara ou coroa)
...
function playGame() {
       ...
       const numRounds = parseInt(prompt("Quantas rodadas quer jogar"));
       let score = 0;
